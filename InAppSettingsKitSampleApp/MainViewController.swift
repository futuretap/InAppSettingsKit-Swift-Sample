...
class MainViewController: UIViewController, UITextViewDelegate, UIPopoverControllerDelegate, IASKSettingsDelegate
{
    ...
    func showSettingsPopover(_ sender: AnyObject)
    {
    ...
    {
        NotificationCenter.default.addObserver(self, selector: #selector(MainViewController.settingDidChange(_:)), name: NSNotification.Name(rawValue: kIASKAppSettingChanged), object: nil)
